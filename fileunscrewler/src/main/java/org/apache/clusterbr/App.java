 ...
 *  <li>See: Oracle's documentation: "Supported Encodings - Canonical Name for java.io API and java.lang API"</li>
 *  <li>If CASE_INSENSITIVE is "true", means to treat lower-case and upper-case characters as equals. "a=A", "text==teXT==TEXT".</li>
            ...
            if (args.length >= 2) {
                ...
                if (file.exists()) {
                    ...
                    System.out.println(String
                            .format("[FileUnscrewler:Main] => Terminated: The File [%s] does not exist.", inputFile));
                }
            } else {
                System.out.println(String.format(
                        "[FileUnscrewler:Main] => Terminated: No enough parameters were supplied (%s).", args.length));
            }
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out.println(
                    String.format("[FileUnscrewler:Error] => Abnormal Program Termination: (%s).", ex.getMessage()));
        }
    }
}
